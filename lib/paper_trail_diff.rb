...
module PaperTrailDiff
  ...
  class << self
    ...
    #: (untyped, untyped, ?associations: Array[String | Symbol], ?ignore: Array[String | Symbol]) -> Diff
    ...
    #: (untyped, from: untyped, to: untyped, ?associations: Array[String | Symbol], ?ignore: Array[String | Symbol]) -> Array[Step]
